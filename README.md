...
SFToolbox is a personal Salesforce utility toolkit created and maintained by Yuta Aoki.
...
**v1.0.0（最新）**
`https://login.salesforce.com/packaging/installPackage.apexp?p0=04tIg000000osJKIAY`
...
1. App Launcher（アプリケーションランチャー）から「**SFToolbox**」を開く
...
| バージョン | 内容 |
|---|---|
| v1.0.0 | タブラベルを「メタデータエクスポート」、カードタイトルを「オブジェクト・項目定義のエクスポート」に変更 |
